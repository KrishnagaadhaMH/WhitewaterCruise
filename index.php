                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                <a href="blog.html" class="dropdown-item">Honeymoon Packages</a>
                                <a href="single.html" class="dropdown-item">Houseboat Packages</a>
                                <a href="destination.html" class="dropdown-item">Kerala Packages</a>
                            </div>
                        </div>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a onclick="smoothScroll()" class="btn btn-primary py-md-3 px-md-5 mt-2">Book a Call back</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        ...
                        <a class="destination-overlay text-white text-decoration-none" href="packages\honey-moon\package-one\index.php">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        ...
                        <a class="destination-overlay text-white text-decoration-none" href="packages\honey-moon\index.php">
...
function smoothScroll(){
    document.querySelector('#callback-container').scrollIntoView({
        behavior: 'smooth'
    });
}
</script>